...
public:
	...
	void ResetKnight() {
		...
		horsemount = false;
		dragonmount = false;
		goldloomMagnet = false;
		regenerativemantle = false;
		fallen = false;
		Knife = false;
		Sword = false;
		Excalibur = false;
		upgradedexcalibur = false;
		lightningexcalibur = false;
		leveltonic = false;
		...
		upgradedgodarmor = false;
		lightningGodarmor = false;
		accuratesword = false;
		shield = false;
		fasttravel = false;
		trickstermove = false;
		soulweavermove = false;
		warforgedmove = false;
		knightmove = false;
		dreadnoughtmove = false;
		executionermove = false;
		maxhealthupgrade = false;
		defenseupgrade = false;
		levelupgrade = false;
		attackupgrade = false;
		armorupgrade = false;
		weaponupgrade = false;
		...
		upgradedvoidshroudslicer = false;
		lightningvoidshroudslicer = false;
		upgradedflaminglongsword = false;
		lightningflaminglongsword = false;
		healingpotionitem = false;
		lightningshard = false;
		glassshoes = false;
		upgradedglassshoes = false;
		lightningglassshoes = false;
		mystichelmet = false;
		upgradedmystichelmet = false;
		lightningmystichelmet = false;
		dragonscalechestplate = false;
		upgradedDragonscalechestplate = false;
		lightningdragonscalechestplate = false;
		travelersbackpack = false;
		playercompanion = false;
		killememiesquest = false;
		questoneprogress = 0;
		craftanitemquest = false;
		questtwoprogress = 0;
		forgeanitemquest = false;
		questthreeprogress = 0;
		usetwoitemsquest = false;
		questfourprogress = 0;
		killabossquest = false;
		isplayingvillage = false;
		questfiveprogress = 0;
		questscompleted = 0;
		trackexcaliburmaxhealth = 0;
		trackflamingmaxhealth = 0;
		trackvoidshroudmaxhealth = 0;
		forgehammer = 0;
		excaliburtracker = 0;
		knifetracker = 0;
		swordtracker = 0;
		...
		shieldtracker = 0;
		godtracker = 0;
		defenseupgradetracker = 0;
		flamingtracker = 0;
		dragontracker = 0;
		shoetracker = 0;
		mystictracker = 0;
		lightningdragontracker = 0;
		upgradeddragontracker = 0;
		lightningexcaliburtracker = 0;
		upgradedexcaltracker = 0;
		lightninglongswordtracker = 0;
		upgradedlongswordtracker = 0;
		lightninggodtracker = 0;
		upgradedgodtracker = 0;
		upgradedmystictracker = 0;
		lightningmystictracker = 0;
		upgradedglasstracker = 0;
		lightningglasstracker = 0;
		voidshroudtracker = 0;
		upgradedvoidshroudtracker = 0;
		lightningvoidshroudtracker = 0;
		tracklevelpotion = 0;
		tracksuperpotion = 0;
		tracksuperiorlevelpotion = 0;
		lostartifact = 0;
		cursedheart = false;
		enchantedsachel = false;
		glowingglasses = false;
		fierynecklace = false;
		shinybelt = false;
		mysteriousstranger = false;
